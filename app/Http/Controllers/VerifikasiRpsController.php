...
class VerifikasiRpsController extends Controller
{
    public function index()
    {
        $data_verif_rps = DB::table('verif_rps')
            ...
            ->select('verif_rps.*', 'dosen.nama_dosen', 'matakuliah.kode_matakuliah', 'thnakd.thn_akd')
    ...
    public function store(Request $request)
    {
        ...
        VerifRps::create($data); // Gunakan model untuk membuat entri baru dalam basis data
