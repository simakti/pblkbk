...
class VerifikasiUasController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.form.form_verif_uas', compact('data_dosen', 'data_repo_uas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'status_verif_uas' => 'required|string',  // Ensure it's a string if that's what you're storing
            'catatan' => 'nullable|string',
            'tanggal_diverifikasi' => 'required|date',
            'file' => 'nullable|file|mimes:pdf,doc,docx|max:2048',  // Example file validation
        ]);
        ...
        // Create a new VerifUas entry
        VerifUas::create([
            'id_repo_uas' => $request->id_repo_uas,
            'id_dosen' => $request->id_dosen,
            'status_verif_uas' => $request->status_verif_uas,  // Assuming 'verifikasi' or 'belum verifikasi' are valid string values
            'catatan' => $request->catatan,
            'tanggal_diverifikasi' => $request->tanggal_diverifikasi,
            //'file' => $filePath,  // Uncomment if file handling is required
        ]);
    ...
    public function edit($id)
    {
        ...
        return view('admin.form.form_edit_verif_uas', compact('verif_uas', 'data_dosen'));
    }
