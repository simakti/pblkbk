<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                @hasrole('dosenpengampu|admin')
                <li class="menu-item"><a href="/repo_uas" class="menu-link"><div data-i18n="Basic">Upload Soal Uas</div></a></li>
                @endhasrole
                @hasrole('kaprodi|admin|penguruskbk')
                <li class="menu-item"><a href="/verif_uas" class="menu-link"><div data-i18n="Basic">Verifikasi Uas</div></a></li>
                @endhasrole
            </ul>
        </li>
        ...
        <li class="menu-item">
            <a href="/grafik_rps" class="menu-link">
                ...
                <div data-i18n="Analytics">Grafik RPS</div>
            </a>
        </li>
        @endhasrole
