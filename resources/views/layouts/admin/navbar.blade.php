    ...
    <ul class="menu-inner py-1">
        ...
        @hasrole('admin')
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    <li class="menu-item"><a href="/dosen" class="menu-link">
                            <div data-i18n="Without menu">Dosen</div>
                        </a></li>
                    <li class="menu-item"><a href="/prodi" class="menu-link">
                            <div data-i18n="Without navbar">Prodi</div>
                        </a></li>
                    <li class="menu-item"><a href="/jurusan" class="menu-link">
                            <div data-i18n="Blank">Jurusan</div>
                        </a></li>
                    <li class="menu-item"><a href="/thnakd" class="menu-link">
                            <div data-i18n="Container">Tahun Akademik</div>
                        </a></li>
                    <li class="menu-item"><a href="/dosenmatakuliah" class="menu-link">
                            <div data-i18n="Container">Dosen Matakuliah</div>
                        </a></li>
                    <li class="menu-item"><a href="/kurikulum" class="menu-link">
                            <div data-i18n="Fluid">Kurikulum</div>
                        </a></li>
                    <li class="menu-item"><a href="/matakuliah" class="menu-link">
                            <div data-i18n="Blank">Matakuliah</div>
                        </a></li>
                    <li class="menu-item"><a href="/pimpinanjurusan" class="menu-link">
                            <div data-i18n="Blank">Pimpinan Jurusan</div>
                        </a></li>
                    <li class="menu-item"><a href="/pimpinanprodi" class="menu-link">
                            <div data-i18n="Blank">Pimpinan Prodi</div>
                        </a></li>
                </ul>
            </li>
        @endhasrole
        ...
        @hasrole('penguruskbk|admin')
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    <li class="menu-item"><a href="/penguruskbk" class="menu-link">
                            <div data-i18n="Account">Dosen KBK</div>
                        </a></li>
                    <li class="menu-item"><a href="/datakbk" class="menu-link">
                            <div data-i18n="Notifications">Data KBK</div>
                        </a></li>
                    <li class="menu-item"><a href="/matkul_kbk" class="menu-link">
                            <div data-i18n="Connections">Mata Kuliah KBK</div>
                        </a></li>
