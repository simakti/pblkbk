...
<! DOCTYPE html>
    ...
    <head>
        ...
        <title>Berita Acara Soal UAS</title>
        <style>
            .header-table {
                width: 100%;
    ...
    <body>
        <div class="kepala">
            <table class="header-table">
                ...
                <tr>
                    <td colspan="2">VERIFIKASI SOAL UJIAN AKHIR SEMESTER GANJIL TAHUN AJARAN 2023/2024</td>
                </tr>
                <tr>
        ...
        <div class="details">
            <p>Telah dilaksanakan rapat verifikasi dan validasi soal ujian Akhir Semester besama KBK dan Kaprodi yang
                dilaksanakan pada : </p>
            ...
            <tbody>
                @foreach ($data_verif_uas as $index => $data)
                    <tr class="table-Light">
                        <td>{{ $index + 1 }}</td>
                        <td>{{ $data->repoUas->matakuliah->semester }}</td>
                        <td>{{ $data->repoUas->matakuliah->nama_matakuliah }}</td>
                        <td>{{ $data->catatan }}</td>
                    </tr>
                @endforeach
            </tbody>
