                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <div class="mt-3">
                            ...
                            <a href="{{ route('penguruskbk.export') }}" class="btn btn-success"><i class="fas fa-download"></i> Export</a>
                            ...
                            <table class="table table-bordered table-striped" id="example" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    @foreach ($data_penguruskbk as $index => $data)
                                        <tr>
                                            <td>{{ $index + 1 + ($data_penguruskbk->currentPage() - 1) * $data_penguruskbk->perPage() }}</td>
