                                    ...
                                    <tbody>
                                        @foreach ($data_datakbk as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('datakbk.edit', $data->id_jenis_kbk) }}"
                                                        class="btn btn-warning btn-sm">Edit</a>
                                                    <form action="{{ route('datakbk.destroy', $data->id_jenis_kbk) }}"
