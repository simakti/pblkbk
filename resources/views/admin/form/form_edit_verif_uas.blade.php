            ...
            <div class="card-body">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('verif_uas.update', $verif_uas->id_verif_uas) }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="id_repo_uas" id="id_repo_uas" class="form-control">
                                        ...
                                        @foreach ($data_repo_uas as $repo)
                                            <option value="{{ $repo->id_repo_uas }}"
                                                @if ($verif_uas->id_repo_uas == $repo->id_repo_uas) selected @endif>{{ $repo->id_repo_uas }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('id_repo_uas')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_diverifikasi"
                                        name="tanggal_diverifikasi" value="{{ $verif_uas->tanggal_diverifikasi }}">
