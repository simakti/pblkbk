...
Route::middleware(['auth', 'verified', 'role:admin'])->group(function () {
    Route::get('/dosenmatakuliah', [DosenMatakuliahController::class, 'index'])->name('pimpinanprodi');
    Route::post('/dosenmatakuliah', [DosenMatakuliahController::class, 'store']);
    Route::get('/dosenmatakuliah/create', [DosenMatakuliahController::class, 'create'])->name('pimpinanprodi.create');
    Route::delete('/dosenmatakuliah/{id}', [DosenMatakuliahController::class, 'destroy'])->name('pimpinanprodi.destroy');
});
